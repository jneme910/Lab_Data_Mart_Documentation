            ...
            WHERE
                (
                    ...
                    AND r.analyte_key IN (
											 ...
											 3211, 3214, 3349, 3352, 3395, 3398, 3213, 3351, 3397, 3212, 3350, 3396,
											 3222, 3225, 3360, 3363, 3406, 3409, 3224, 3362, 3408, 3223, 3361, 3407,
											 3230, 3233, 3327, 3330, 3331, 3334, 3368, 3371, 3414, 3417, 3232, 3329, 
											 3333, 3370, 3416, 3231, 3328, 3332, 3369, 3415, 3235, 3238, 3335, 3338, 
											 3339, 3342, 3372, 3375, 3418, 3421, 3237, 3337, 3341, 3374, 3420, 3236, 
											 3336, 3340, 3373, 3419, 3226, 3229, 3364, 3367, 3410, 3413, 3228, 3366, 3412,
											 3227, 3365, 3411, 3215, 3218, 3353, 3356, 3399, 3402, 3217, 3355, 3401, 
											 3216, 3354, 3400, 2188, 3306, 2185, 3303, 2186, 3304, 2187, 3305, 2183, 3301,
											 2184, 3302, 2213, 3337, 2214, 3348, 1519, 3219, 3220, 3357, 3358, 3403, 3404,
											 2211, 3345, 1330, 2212, 3346, 2181, 2182
                                         )
            ...
            (
                ...
                WHERE
                    ...
                    AND (result.analyte_key IN (
                                                   568, 652, 653, 721, 722, 723, 791, 1291, 1292, 1440, 2099, 3211, 
												   3214, 3349, 3352, 3395, 3398
                                               )
                        )
                UNION
                SELECT
        ...
        FROM
            (
                ...
                WHERE
                    ...
                    AND (result.result_source_key = q1.result_source_key)
                    AND (result.analyte_key IN (
                                                   518, 654, 655, 736, 737, 738, 796, 1303, 1304, 1450, 2101, 3222, 
												   3225, 3360, 3363, 3406, 3409
                                               )
                        )
                UNION
                SELECT
            ...
            (
                ...
                WHERE
                    ...
                    AND (result.analyte_key IN (
                                                   ...
                                                   2102, 3230, 3233, 3327, 3330, 3331, 3334, 3368, 3371, 3414, 3417
                                               )
                        )
                UNION
                SELECT
                ...
                WHERE
                    ...
                    AND (result.result_source_key = q1.result_source_key)
                    AND (analyte_key IN (
                                            1158, 1309, 1310, 1455, 1456, 2034, 2035, 3232, 3329, 3333, 3370, 3416
                                        )
                        )
                UNION
                SELECT
                ...
                WHERE
                    ...
                    AND (result.result_source_key = q1.result_source_key)
                    AND (analyte_key IN (
                                            1048, 1307, 1308, 1457, 1458, 2028, 2033, 3231, 3328, 3332, 3369, 3415
                                        )
                        )
                UNION
                SELECT
            ...
            (
                ...
                WHERE
                    ...
                    AND (result.analyte_key IN (
                                                   ...
                                                   2104, 3235, 3238, 3335, 3338, 3339, 3342, 3372, 3375, 3418, 3421
                                               )
                        )
                UNION
                SELECT
                ...
                WHERE
                    ...
                    AND (result.result_source_key = q1.result_source_key)
                    AND (analyte_key IN (
                                            1153, 1321, 1322, 1466, 1467, 2039, 2045, 3237, 3337, 3341, 3374, 3420
                                        )
                        )
                UNION
                SELECT
                ...
                WHERE
                    ...
                    AND (result.result_source_key = q1.result_source_key)
                    AND (analyte_key IN (
                                            1043, 1319, 1320, 1464, 1465, 2038, 2044, 3236, 3336, 3340, 3373, 3419
                                        )
                        )
                UNION
                SELECT
            ...
            (
                ...
                WHERE
                    ...
                    AND (result.analyte_key IN (
                                                   ...
                                                   732, 792, 1459, 2103, 3226, 3229, 3364, 3367, 3410, 3413
                                               )
                        )
                UNION
                SELECT
            ...
            (
                ...
                WHERE
                    ...
                    AND (result.analyte_key IN (
                                                   ...
                                                   1514, 1515, 1516, 1517, 1518, 1519, 3219, 3220, 3357, 3358, 3403, 3404
                                               )
                        )
                UNION
                SELECT
        ...
        FROM
            (
                ...
                WHERE
                    ...
                    AND (result.result_source_key = q1.result_source_key)
                    AND (result.analyte_key IN (
                                                   563, 636, 803, 1520, 2094, 2211, 3345
                                               )
                        )
                UNION
                SELECT
