...
FROM information_schema.columns gg WHERE TABLE_NAME IN ('analyte', 'pedon', 'SDA_analysis_procedure', 'SDA_Calculations_Including_Estimates_And_Default_Values', 'SDA_Chemical_Properties', 'SDA_Major_And_Trace_Elements_And_Oxides', 'SDA_method_code',  'SDA_Mineralogy_Glass_Count', 'SDA_Physical_Properties',  'SDA_webmap', 'SDA_XRay_And_Thermal', 'site', 'rosetta', 'combine_nasis_ncss', 'preparation', 'layer'  )
