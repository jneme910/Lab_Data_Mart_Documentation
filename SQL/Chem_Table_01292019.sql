...
go
	...
	------------------------------------------ begin - RUN THE FOLLOWING BY ITSELF
	  ...
	  CREATE TABLE result_light_chem(result_key INT NOT NULL  , result_source_key INT, 
	  ...
	  prep_code VARCHAR(64) , proced_code VARCHAR(12),
	   CONSTRAINT pk_result_light_chem PRIMARY KEY CLUSTERED (result_key)
	  )
	  go

	  ---------------  33 seconds  --- (10601391 rows affected)
	  INSERT INTO result_light_chem 
...
FROM dbo.result r
	...
	CREATE INDEX  result_light_chem_idx1c ON  result_light_chem (analyte_key, result_type, result_source_key,  result_reliability) INCLUDE (result_value, proced_code,prep_code)
	CREATE INDEX  result_light_chem_idx1b ON  result_light_chem (analyte_key,  result_reliability)
	CREATE INDEX  result_light_chem_result_source_key_idx2 ON  result_light_chem (result_source_key )
	CREATE INDEX result_light_chem_prep_key_idx3 ON  result_light_chem (prep_key)
	CREATE INDEX result_source_system_key_idx4 ON result_light_chem (source_system_key)
	CREATE INDEX result_light_chem_prep_code_idx5 ON  result_light_chem (prep_code)
...
Table 'result_light_chem'. Scan count 18767, logical reads 81437, physical reads 0, read-ahead reads 6, lob logical reads 0, lob physical reads 0, lob read-ahead reads 0.
...
--ca_nh4_ph_7 g
                           (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 2)) AS Expr1
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 2) AS decimal(10, 2)) AS Expr1
                               FROM           result_light_chem result
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
							...
							---(SELECT        TOP (1) CAST(ROUND (  CAST (result_value AS float), 2) AS decimal(10, 2)) AS Expr1
							 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result_value, '4.1') AS decimal(10, 2)) AS Expr1
                               FROM            (SELECT        result.result_value, 'S' AS prep_code
                                                         FROM           result_light_chem AS result
                                                         WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer result') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND (result.result_source_key = q1.result_source_key) 
...
--acidity_bacl2_tea_ph_8_2 g
								--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 2) AS decimal(10, 2)) AS Expr1
								 ...
								 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 2)) AS Expr1
													   ...
													   WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
																				 (result.result_reliability IS NULL OR
																				 result.result_reliability = '0') AND (result.analyte_key in (73, 1121))) AS acidity_bacl2_tea_ph_8_2,
													  (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
													   FROM            result_light_chem result
													   WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
																				 (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
...
(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 2)) AS Expr1
					         --  (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (55))) AS aluminum_kcl_extractable,		          
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
...
--manganese_kcl_extractable g
							...
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 2) AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (56))) AS manganese_kcl_extractable,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
...
--iron_kcl_extractable g
							...
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE  (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (683))) AS iron_kcl_extractable,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 2) AS decimal(10, 2)) AS Expr1
							 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (62,68,679))) AS cec_nh4_ph_7,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
		          ...
		          (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (45, 460))) AS total_carbon_ncs,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (45, 460))) AS total_carbon_ncs_method,
...
---total_nitrogen_ncs		g												 		
							...
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.3') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE  (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (79, 461))) AS total_nitrogen_ncs,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (79, 461))) AS total_nitrogen_ncs_method,	
...
---total_sulfur_ncs		g												 
							...
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key in (362, 462))) AS total_sulfur_ncs,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (362, 462))) AS total_sulfur_ncs_method,	
...
---organic_carbon_walkley_black g
                               ...
                               WHERE      (isnumeric(result.result_value) = 1) AND   (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 780)) AS organic_carbon_walkley_black,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 780)) AS oc_walkley_black_method,	
...
---fe_dithionite_citrate_extract g																	 
							...
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 52)) AS fe_dithionite_citrate_extract,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 52)) AS iron_dc_extract_method,	
...
--aluminum_dithionite_citrate g
					...
					--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE      (isnumeric(result.result_value) = 1) AND   (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 51)) AS aluminum_dithionite_citrate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 51)) AS aluminum_dc_extract_method,	
...
--manganese_dithionite_citrate g
					...
					(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 53)) AS manganese_dithionite_citrate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 53)) AS manganese_dc_extract_method,	
...
--ammoniumoxalate_opticaldensity 	g												 								 								 
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 452)) AS ammoniumoxalate_opticaldensity,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 452)) AS ammonium_ox_opt_dens_method,	
...
--fe_ammoniumoxalate_extractable g
						...
						--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 47)) AS fe_ammoniumoxalate_extractable,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 47)) AS iron_ammonium_oxalate_method,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 46)) AS aluminum_ammonium_oxalate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 46)) AS al_ammonium_oxalate_method,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 50)) AS silica_ammonium_oxalate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 50)) AS silica_ammonium_oxalate_method,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '7.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 48)) AS manganese_ammonium_oxalate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 48)) AS mn_ammonium_oxalate_method,	
...
--carbon_sodium_pyro_phospate g
							...
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 58)) AS carbon_sodium_pyro_phospate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 58)) AS c_na_pyro_phosphate_method,	
...
--iron_sodium_pyro_phosphate g
							...
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 59)) AS iron_sodium_pyro_phosphate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 59)) AS iron_na_pyro_phosphate_method,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1			
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 57)) AS aluminum_na_pyro_phosphate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 57)) AS aluminum_na_pyro_phosphate_met,	
...
--manganese_na_pyro_phosphate	(Possible Flag Might need to revert back to AsymArithRnd)	g												 
							...
							-- (SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 60)) AS manganese_na_pyro_phosphate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 60)) AS mn_na_pyro_phosphate_method,
...
--ph_kcl	g													 								 
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 244)) AS ph_kcl,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 244)) AS ph_kcl_method, 
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
							(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 455)) AS ph_cacl2,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 455)) AS ph_cacl2_method, 
...
-- (SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
				(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 247)) AS ph_h2o,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 247)) AS ph_h2o_method, 
...
--ph_saturated_paste	g													 
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 456)) AS ph_saturated_paste,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 456)) AS ph_saturated_paste_method, 
...
----ph_oxidized g
							--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 246)) AS ph_oxidized,
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1147)) AS ph_oxidized_initial,
							 (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (246,1147))) AS ph_oxidized_method, 
...
--ph_naf
						...
						(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 245)) AS ph_naf,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 245)) AS ph_naf_method, 
...
--ph_water_extract g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1363)) AS ph_water_extract,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1363)) AS ph_water_extract_method, 	
...
--caco3_lt_2_mm g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.0') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 41)) AS caco3_lt_2_mm,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 41)) AS caco3_lt_2_mm_method, 	
...
--corrected_gypsum_lt_2_mm (Possible Flag Might need to revert back to AsymArithRnd)g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.0') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 485)) AS corrected_gypsum_lt_2_mm,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 485)) AS corrected_gyp_lt_2_mm_method, 		
...
--resistivity_saturated_paste g
	 			--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '7.0') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 358)) AS resistivity_saturated_paste,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 358)) AS resistivity_sp_method, 	
...
--ca_satx g
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 348)) AS ca_satx,
							  (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 348)) AS ca_satx_method,
...
--mg_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 353)) AS mg_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 353)) AS mg_satx_method,
...
--ca_plus_mg_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 788)) AS ca_plus_mg_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 788)) AS ca_plus_mg_satx_method,
...
--na_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 359)) AS na_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 359)) AS na_satx_method,
...
--k_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 357)) AS k_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 357)) AS k_satx_method,
...
--co3_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 349)) AS co3_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 349)) AS co3_satx_method,
...
--hco3_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 345)) AS hco3_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 345)) AS hco3_satx_method,
...
--co3_plus_hco3_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 787)) AS co3_plus_hco3_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 787)) AS co3_plus_hco3_satx_method,
...
--cl_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 350)) AS cl_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 350)) AS cl_satx_method,
...
--f_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 352)) AS f_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 352)) AS f_satx_method,
...
--po4_satx (Possible Flag Might need to revert back to AsymArithRnd)g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 356)) AS po4_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 356)) AS po4_satx_method,
...
--br_satx (Possible Flag Might need to revert back to AsymArithRnd)g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 347)) AS br_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 347)) AS br_satx_method,
...
--oac_satx (Possible Flag Might need to revert back to AsymArithRnd) g
	 			--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 2)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 344)) AS oac_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 344)) AS oac_satx_method,
...
--so4_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 360)) AS so4_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 360)) AS so4_satx_method,
...
--no2_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 355)) AS no2_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 355)) AS no2_satx_method,
...
--no3_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 354)) AS no3_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 354)) AS no3_satx_method,
...
--h20_satx g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 361)) AS h20_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 361)) AS h20_satx_method,
...
--electrical_conductivity_satx
				...
				--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 2) AS decimal(10, 2)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.2') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 351)) AS electrical_conductivity_satx,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 351)) AS electrical_cond_satx_method,
...
--ec_predict_one_to_two
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.2') AS decimal(10, 2)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 343)) AS ec_predict_one_to_two,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 343)) AS ec_predict_one_to_two_method,
...
--melanic_index
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 482)) AS melanic_index,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 482)) AS melanic_index_method,
...
--new_zealand_phosphorus_retent
					...
					--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.0') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 252)) AS new_zealand_phosphorus_retent,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 252)) AS new_zealand_phos_retent_method,
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
	 				(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 49)) AS phosphorus_ammonium_oxalate,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 49)) AS phosphorus_ammonium_oxalate_method,
...
--phosphorus_anion_resin g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1128)) AS phosphorus_anion_resin_one_hr,
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1129)) AS phosphorus_anion_resin_24_hr,
			               ...
			               (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (1128,1129))) AS phosphorus_anion_resin_method,
...
--phosphorus_bray1 (Possible Flag Might need to revert back to AsymArithRnd) g
	 			--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 249)) AS phosphorus_bray1,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 249)) AS phosphorus_bray1_method,
...
--phosphorus_bray2 g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 250)) AS phosphorus_bray2,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 250)) AS phosphorus_bray2_method,
...
--phosphorus_citric_acid (Modified need to double check) g
	 			...
	 			--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 251)) AS phosphorus_citric_acid,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 251)) AS phosphorus_citric_acid_method,
...
--phosphorus_mehlich_3 g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 483)) AS phosphorus_mehlich_3,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 483)) AS phosphorus_mehlich_3_method,
...
--phosphorus_olsen g
	 			--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 253)) AS phosphorus_olsen,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 253)) AS phosphorus_olsen_method,
...
--phosphorus_water g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE      (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 248)) AS phosphorus_water,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 248)) AS phosphorus_water_method,
...
--nitrate_1m_kcl g
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 77)) AS nitrate_1m_kcl,
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 77)) AS nitrate_1m_kcl_method,	
--water_extract_method	(conversion stop)													 													 													 												 														 
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               FROM            result_light_chem result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (1352, 1365, 1366, 1367, 1353, 1354, 1369, 1368, 1355, 1371, 1370, 1372, 1364, 1356, 1373, 1381, 1375, 1376, 1377, 1379, 1357, 1386, 1358, 1359, 1380, 1374, 2098, 1382, 1378, 1383, 1360, 1384, 1385))) AS water_extract_method	,															 	
...
--acetate_water_extractable
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1352)) AS acetate_water_extractable,
...
--aluminum_water_extractable
	 			--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1365)) AS aluminum_water_extractable,
--arsenic_water_extractable
					...
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1366)) AS arsenic_water_extractable,
---barium_water_extractable
	 			--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
					(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1367)) AS  barium_water_extractable,
-- boron_water_extractable g
					--	(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
						(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1353)) AS  boron_water_extractable,
--bromide_water_extractable g
	...
	(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1354)) AS  bromide_water_extractable, 
--cadmium_water_extractable g
	...
	(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1369)) AS  cadmium_water_extractable, 
...
(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(18, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1368)) AS  calcium_water_extractable, 
...
--Error converting data type varchar to numeric.
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1355)) AS  chloride_water_extractable, 
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1371)) AS  chromium_water_extractabe, 
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1370)) AS  cobalt_water_extractable, 
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1372)) AS  copper_water_extracable, 
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1364)) AS  ec_water_extract,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1356)) AS  fluoride_water_extractable,	
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1373)) AS  iron_water_extractable,	
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1381)) AS  lead_water_extractable,	
...
(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(18, 2)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1375)) AS  magnesium_water_extractable, 
														 															 														 											-
...
--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1376)) AS  manganese_water_extractable, 
...
--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1377)) AS  molybdenum_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1379)) AS  nickel_water_extractable,
...
--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '6.2') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1386)) AS  nitrate_n_water_extractable,	
...
--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1357)) AS  nitrate_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1358)) AS  nitrite_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1359)) AS  phosphorus_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1380)) AS  phosphate_water_extractable,
...
--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1374)) AS potassium_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 2098)) AS selenium_water_extractable,
...
--Error converting data type varchar to numeric.
 ...
 (SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(18, 5)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1382)) AS silicon_water_extractable,
...
(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(18, 5)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1378)) AS sodium_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1383)) AS strontium_water_extractable,
...
(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(18, 5)) AS Expr1
 --(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1360)) AS sulfate_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1384)) AS vanadium_water_extractable,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1385)) AS zinc_water_extractable,									 
...
--mehlich_3_extractable												 													 													 												 														 
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key IN (1331, 1332, 1333, 1335, 1334, 1337, 1336, 1338, 1339, 1346, 1341, 1342, 1349, 1344, 1340, 1347, 1350, 1343, 1351, 1348, 1345))) AS mehlich_3_extractable_method	,												
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1331)) AS aluminum_mehlich3_extractable	,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1332)) AS arsenic_mehlich3_extractable,																 			 															 															 	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1333)) AS barium_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1335)) AS cadmium_mehlich3_extractable,		
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1334)) AS calcium_mehlich3_extractable,																 														 														 													 														 
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1337)) AS chromium_mehlich3_extractable,																 				
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1336)) AS cobalt_mehlich3_extractable,		
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1338)) AS copper_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE  (isnumeric(result.result_value) = 1) AND        (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1339)) AS iron_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE      (isnumeric(result.result_value) = 1) AND    (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1346)) AS lead_mehlich3_extractable,													
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1341)) AS magnesium_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1342)) AS manganese_mehlich3_extractable,	
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1349)) AS molybdenum_mehlich3_extractabl,
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1344)) AS nickel_mehlich3_extractable,																 					
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1345)) AS phosphorus_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1340)) AS potassium_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1347)) AS selenium_mehlich3_extractable,	
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1350)) AS silicon_mehlich3_extractable,													
...
--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
 (SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE    (isnumeric(result.result_value) = 1) AND      (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1343)) AS sodium_mehlich3_extractable,		
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE     (isnumeric(result.result_value) = 1) AND     (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1351)) AS strontium_mehlich3_extractable,	
...
(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
                               ...
                               WHERE   (isnumeric(result.result_value) = 1) AND       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) AND (result.prep_code = q1.prep_code) AND 
                                                         (result.result_reliability IS NULL OR
                                                         result.result_reliability = '0') AND (result.analyte_key = 1348)) AS zinc_mehlich3_extractable       
INTO  #tempXX

-------------- do no use view -- use new table here as well
FROM            dbo.layer 
INNER JOIN result_light_chem q1 ON dbo.layer.layer_key = q1.result_source_key 
