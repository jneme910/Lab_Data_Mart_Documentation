...
(
	...
	CASE WHEN TAB.name NOT LIKE 'lab_%' THEN CONCAT ('lab_', TAB.name) ELSE TAB.name END AS name 
	
	,COL.name AS COLNAME,COL.column_id,COL.is_identity ,col.user_type_id
