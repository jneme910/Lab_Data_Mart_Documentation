...
INTO lab_calculations_including_estimates_and_default_values6
FROM  dbo.layer 
INNER JOIN result_light AS q1 ON dbo.layer.layer_key = q1.result_source_key 

CREATE INDEX  lab_calculations_including_estimates_and_default_values6_idx1c ON  lab_calculations_including_estimates_and_default_values6 (labsampnum, result_source_key) INCLUDE (prep_code)
CREATE INDEX  lab_calculations_including_estimates_and_default_values2_result_source_key_idx6 ON  lab_calculations_including_estimates_and_default_values6 (result_source_key )
CREATE INDEX lab_calculations_including_estimates_and_default_values2_prep_code_idx6 ON  lab_calculations_including_estimates_and_default_values6 (prep_code)
