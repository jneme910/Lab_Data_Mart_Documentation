...
INTO lab_mineralogy_glass_count
FROM #tempXX 
...
GO
	...
	CREATE INDEX  lab_mineralogy_glass_count_idx1c ON  lab_mineralogy_glass_count (labsampnum, result_source_key) INCLUDE (prep_code)
	CREATE INDEX  lab_mineralogy_glass_count_result_source_key_idx2 ON  lab_mineralogy_glass_count (result_source_key )
	CREATE INDEX lab_mineralogy_glass_count_prep_code_idx5 ON  lab_mineralogy_glass_count (prep_code)