...
INTO lab_calculations_including_estimates_and_default_values
...
CREATE INDEX  lab_calculations_including_estimates_and_default_values_idx1c ON  lab_calculations_including_estimates_and_default_values (labsampnum, result_source_key) INCLUDE (prep_code)
CREATE INDEX  lab_calculations_including_estimates_and_default_values_result_source_key_idx2 ON  lab_calculations_including_estimates_and_default_values (result_source_key )
CREATE INDEX lab_calculations_including_estimates_and_default_values_prep_code_idx5 ON  lab_calculations_including_estimates_and_default_values (prep_code)
