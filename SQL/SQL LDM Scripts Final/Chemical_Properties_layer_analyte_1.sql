...
--Updated Jason Nemecek 12-14-2019
-- 2 hours 2 minutes
...
go
	  ...
	  -------------------------------------------
	  TRUNCATE TABLE  IF EXISTS result_light_chem
	  TRUNCATE TABLE  IF EXISTS result_light_test2
	  TRUNCATE TABLE  IF EXISTS result_light
	  TRUNCATE TABLE  IF EXISTS #tempXX
	  TRUNCATE TABLE  IF EXISTS lab_chemical_properties_layer_analyte_1
...
--ca_nh4_ph_7 g
                        (SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 2) AS decimal(10, 2)) AS Expr1
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 2) AS decimal(10, 2)) AS Expr1
                               FROM           result_light result
                               WHERE       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) --AND (result.prep_code = q1.prep_code)
							    AND 
                             ...
                             (SELECT        TOP (1) ISNULL(result.proced_code, '') AS Expr1
                               ...
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_value <> '') AND (NOT (result.result_value IS NULL)) AND 
                                                         (result.result_source_key = q1.result_source_key) --AND (result.prep_code = q1.prep_code) 
														 AND (CASE WHEN result.result_reliability IS NULL THEN 1 WHEN result.result_reliability = '0' THEN 1 ELSE 2 END = 1
...
---total_nitrogen_ncs		g												 		
							(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 3) AS decimal(10, 3)) AS Expr1
...
--manganese_dithionite_citrate g
					--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '4.1') AS decimal(10, 3)) AS Expr1
					(SELECT      TOP (1) CAST(ROUND (  CAST (LTRIM(cast(result.result_value as real)) AS REAL), 3) AS decimal(10, 3)) AS Expr1
...
--carbon_sodium_pyro_phospate g
								(SELECT        TOP (1) CAST(dbo.AsymArithRnd(LTRIM(cast(result.result_value as real)), '5.2') AS decimal(10, 2)) AS Expr1
							--(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS float), 3) AS decimal(10, 3)) AS Expr1
                               FROM              result_light result
                               WHERE       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key)-- --AND (result.prep_code = q1.prep_code)
							    AND 
...
--ph_kcl	g													 								 
							(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 1) AS decimal(10, 1)) AS Expr1
...
--corrected_gypsum_lt_2_mm (Possible Flag Might need to revert back to AsymArithRnd)g
	 				(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 0) AS decimal(10, 0)) AS Expr1
...
--resistivity_saturated_paste g
	 				(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 3) AS decimal(10, 0)) AS Expr1
...
--hco3_satx g
	 				(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 2) AS decimal(10,1)) AS Expr1
					--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '5.1') AS decimal(10, 2)) AS Expr1
                               FROM              result_light result
                               WHERE       (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) --AND (result.prep_code = q1.prep_code) 
							   AND 
...
--(SELECT        TOP (1) CAST(dbo.AsymArithRnd(result.result_value, '3.1') AS decimal(10, 3)) AS Expr1
(SELECT        TOP (1) CAST(ROUND (  CAST (result.result_value AS REAL), 1) AS decimal(18, 1)) AS Expr1
                               FROM              result_light result
                               WHERE        (result.result_type = 'layer analyte') AND (result.result_source_key = q1.result_source_key) --AND (result.prep_code = q1.prep_code) 
							   AND 
                                                         (CASE WHEN result.result_reliability IS NULL THEN 1 WHEN result.result_reliability = '0' THEN 1 ELSE 2 END = 1
...
INTO lab_chemical_properties_layer_analyte_1
FROM #tempXX
...
CREATE INDEX  lab_chemical_properties_layer_analyte_1_idx1c ON  lab_chemical_properties_layer_analyte_1 (labsampnum, result_source_key) INCLUDE (prep_code)
CREATE INDEX  lab_chemical_properties_layer_analyte_1_result_source_key_idx2 ON  lab_chemical_properties_layer_analyte_1 (result_source_key )
CREATE INDEX  lab_chemical_properties_layer_analyte_1_prep_code_idx5 ON  lab_chemical_properties_layer_analyte_1 (prep_code)
