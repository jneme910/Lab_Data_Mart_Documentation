...
go
	  ...
	  DROP TABLE IF EXISTS lab_calculations_including_estimates_and_default_values
...
INTO lab_calculations_including_estimates_and_default_values3
FROM  dbo.layer 
INNER JOIN result_light AS q1 ON dbo.layer.layer_key = q1.result_source_key 

CREATE INDEX  lab_calculations_including_estimates_and_default_values3_idx1c ON  lab_calculations_including_estimates_and_default_values3 (labsampnum, result_source_key) INCLUDE (prep_code)
CREATE INDEX  lab_calculations_including_estimates_and_default_values3_result_source_key_idx2 ON  lab_calculations_including_estimates_and_default_values3 (result_source_key )
CREATE INDEX lab_calculations_including_estimates_and_default_values3_prep_code_idx5 ON  lab_calculations_including_estimates_and_default_values3 (prep_code)
