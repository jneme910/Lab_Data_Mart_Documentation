...
LEFT JOIN dbo.bridge_proced_ss AS b ON r.procedure_key = b.procedure_key AND 
	...
	CREATE INDEX result_source_system_key_idx4 ON result_light (source_system_key)<!DOCTYPE html>
<html>
  <head>
...
INTO lab_major_and_trace_elements_and_oxides
FROM #tempXX 
...
GO
	...
	CREATE INDEX  lab_major_and_trace_elements_and_oxides_idx1c ON  lab_major_and_trace_elements_and_oxides (labsampnum, result_source_key) INCLUDE (prep_code)
	CREATE INDEX  lab_major_and_trace_elements_and_oxides_result_source_key_idx2 ON  lab_major_and_trace_elements_and_oxides (result_source_key )
	CREATE INDEX lab_major_and_trace_elements_and_oxides_prep_code_idx5 ON  lab_major_and_trace_elements_and_oxides (prep_code)