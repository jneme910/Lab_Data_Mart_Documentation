...
--CORRELATED AS
SELECT peiidref AS corr_peiid_ref, classdate AS corr_classdate, cpetaxhistory.petaxhistoryiid AS corr_petaxhistoryiid,
(select top 1  [ChoiceSequence]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND classtype  = ChoiceValue 
and DomainName = 'classification_type'  AND
dm.DomainID = dd.DomainID ORDER BY classtype DESC)  AS corr_class_seq,
...
CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxonkind  = ChoiceValue 
and DomainName = 'component_kind'  AND
dm.DomainID = dd.DomainID ORDER BY taxonkind  DESC) AS varchar) AS corr_class_type , 

cpetaxhistory.recwlupdated AS corr_obj,
CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxorder  = ChoiceValue 
and DomainName = 'taxonomic_order'  AND
dm.DomainID = dd.DomainID ORDER BY taxorder DESC) AS varchar) AS  corr_taxorder , 

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxsuborder  = ChoiceValue 
and DomainName = 'taxonomic_suborder'  AND
dm.DomainID = dd.DomainID ORDER BY taxsuborder DESC) AS varchar) AS corr_taxsuborder,  

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxgrtgroup  = ChoiceValue 
and DomainName = 'taxonomic_great_group'  AND
dm.DomainID = dd.DomainID ORDER BY taxgrtgroup DESC) AS varchar) AS corr_taxgrtgroup,  

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxsubgrp  = ChoiceValue 
and DomainName = 'taxonomic_subgroup'  AND
dm.DomainID = dd.DomainID ORDER BY taxorder DESC) AS varchar) AS  corr_taxsubgrp  ,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxpartsize = ChoiceValue 
and DomainName = 'taxonomic_family_particle_size'  AND
dm.DomainID = dd.DomainID ORDER BY taxpartsize DESC) AS varchar) AS corr_taxpartsize ,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxpartsizemod = ChoiceValue 
and DomainName = 'taxonomic_family_part_size_mod'  AND
dm.DomainID = dd.DomainID ORDER BY taxpartsizemod DESC) AS varchar) AS corr_taxpartsizemod,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxfamhahatmatcl = ChoiceValue 
and DomainName = 'taxonomic_family_haht_mat_class'  AND
dm.DomainID = dd.DomainID ORDER BY taxfamhahatmatcl DESC) AS varchar) AS corr_taxfamhahatmatcl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxceactcl= ChoiceValue 
and DomainName = 'taxonomic_family_c_e_act_class'  AND
dm.DomainID = dd.DomainID ORDER BY taxceactcl DESC) AS varchar) AS corr_taxceactcl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxreaction= ChoiceValue 
and DomainName = 'taxonomic_family_reaction'  AND
dm.DomainID = dd.DomainID ORDER BY taxreaction DESC) AS varchar) AS corr_taxreaction,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxtempcl = ChoiceValue 
and DomainName = 'taxonomic_family_temp_class'  AND
dm.DomainID = dd.DomainID ORDER BY taxtempcl DESC) AS varchar) AS corr_taxtempcl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxmoistscl = ChoiceValue 
and DomainName = 'taxonomic_moisture_subclass'  AND
dm.DomainID = dd.DomainID ORDER BY taxmoistscl DESC) AS varchar) AS corr_taxmoistscl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxtempregime = ChoiceValue 
and DomainName = 'taxonomic_temp_regime'  AND
dm.DomainID = dd.DomainID ORDER BY taxtempregime DESC) AS varchar) AS corr_taxtempregime,
osdtypelocflag as corr_osdtypelocflag, petaxhistoryiid as corr_iid,

SUBSTRING(  (  SELECT  ( ', ' +  [ChoiceName] ) from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].petaxhistfmmin AS cthm, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref AND cthm.pedtaxhistoryiidref=cth.petaxhistoryiid
AND taxminalogy = ChoiceValue 
and DomainName = 'taxonomic_family_mineralogy'  AND
dm.DomainID = dd.DomainID
GROUP BY ChoiceName, taxminalogy
ORDER BY taxminalogy DESC , ChoiceName
FOR XML PATH('') ), 3, 50)  AS corr_minalogy,

SUBSTRING(  (  SELECT  ( ', ' +  [ChoiceName] ) from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].petxhistfmother  AS cthmo, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref AND  cthmo.pedtaxhistoryiidref=cth.petaxhistoryiid 
AND taxfamother = ChoiceValue 
and DomainName = 'taxonomic_family_other'  AND
dm.DomainID = dd.DomainID
GROUP BY ChoiceName, taxfamother 
ORDER BY taxfamother DESC, ChoiceName 
FOR XML PATH('') ), 3, 50)  AS corr_other

FROM #ncss_one2 
INNER JOIN petaxhistory AS  cpetaxhistory ON cpetaxhistory.peiidref=#ncss_one2.peiid 

---Sub query to get the top correlated (Many to one relationships)
		AND petaxhistoryiid IN (SELECT TOP 1 petaxhistoryiid FROM petaxhistory AS pt2 WHERE 
		(cpetaxhistory.petaxhistoryiid) IS NOT NULL
		AND cpetaxhistory.classtype IN (1,3) AND #ncss_one2.peiid IN ( pt2.peiidref)
...
SELECT peiidref AS samp_peiid_ref, classdate AS samp_classdate, spetaxhistory.petaxhistoryiid AS samp_petaxhistoryiid,
(select top 1  [ChoiceSequence]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND classtype  = ChoiceValue 
and DomainName = 'classification_type'  AND
dm.DomainID = dd.DomainID ORDER BY classtype DESC)  AS samp_class_seq,
...
AND taxonkind  = ChoiceValue 
and DomainName = 'component_kind'  AND
dm.DomainID = dd.DomainID ORDER BY taxonkind  DESC) AS varchar) AS samp_class_type , 
...
AND taxorder  = ChoiceValue 
and DomainName = 'taxonomic_order'  AND
dm.DomainID = dd.DomainID ORDER BY taxorder DESC) AS varchar) AS  samp_taxorder , 

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxsuborder  = ChoiceValue 
and DomainName = 'taxonomic_suborder'  AND
dm.DomainID = dd.DomainID ORDER BY taxsuborder DESC) AS varchar) AS samp_taxsuborder,  

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxgrtgroup  = ChoiceValue 
and DomainName = 'taxonomic_great_group'  AND
dm.DomainID = dd.DomainID ORDER BY taxgrtgroup DESC) AS varchar) AS samp_taxgrtgroup,  

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxsubgrp  = ChoiceValue 
and DomainName = 'taxonomic_subgroup'  AND
dm.DomainID = dd.DomainID ORDER BY taxorder DESC) AS varchar) AS  samp_taxsubgrp  ,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxpartsize = ChoiceValue 
and DomainName = 'taxonomic_family_particle_size'  AND
dm.DomainID = dd.DomainID ORDER BY taxpartsize DESC) AS varchar) AS samp_taxpartsize ,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxpartsizemod = ChoiceValue 
and DomainName = 'taxonomic_family_part_size_mod'  AND
dm.DomainID = dd.DomainID ORDER BY taxpartsizemod DESC) AS varchar) AS samp_taxpartsizemod,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxfamhahatmatcl = ChoiceValue 
and DomainName = 'taxonomic_family_haht_mat_class'  AND
dm.DomainID = dd.DomainID ORDER BY taxfamhahatmatcl DESC) AS varchar) AS samp_taxfamhahatmatcl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxceactcl= ChoiceValue 
and DomainName = 'taxonomic_family_c_e_act_class'  AND
dm.DomainID = dd.DomainID ORDER BY taxceactcl DESC) AS varchar) AS samp_taxceactcl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxreaction= ChoiceValue 
and DomainName = 'taxonomic_family_reaction'  AND
dm.DomainID = dd.DomainID ORDER BY taxreaction DESC) AS varchar) AS samp_taxreaction,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxtempcl = ChoiceValue 
and DomainName = 'taxonomic_family_temp_class'  AND
dm.DomainID = dd.DomainID ORDER BY taxtempcl DESC) AS varchar) AS samp_taxtempcl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxmoistscl = ChoiceValue 
and DomainName = 'taxonomic_moisture_subclass'  AND
dm.DomainID = dd.DomainID ORDER BY taxmoistscl DESC) AS varchar) AS samp_taxmoistscl,

CAST((select top 1  [ChoiceName]  from [nasis].[dbo].petaxhistory AS cth, [nasis].[dbo].MetadataDomainMaster  AS dm, [nasis].[dbo].MetadataDomainDetail AS dd 
WHERE #ncss_one2.peiid = cth.peiidref
AND taxtempregime = ChoiceValue 
and DomainName = 'taxonomic_temp_regime'  AND
dm.DomainID = dd.DomainID ORDER BY taxtempregime DESC) AS varchar) AS samp_taxtempregime,
osdtypelocflag as samp_osdtypelocflag, petaxhistoryiid as samp_iid,
...
GROUP BY ChoiceName, taxminalogy
ORDER BY taxminalogy DESC , ChoiceName
FOR XML PATH('') ), 3, 50)  AS samp_minalogy,
...
GROUP BY ChoiceName, taxfamother 
ORDER BY taxfamother DESC, ChoiceName 
FOR XML PATH('') ), 3, 50)  AS samp_other

FROM #ncss_one2 
INNER JOIN petaxhistory AS  spetaxhistory ON spetaxhistory.peiidref=#ncss_one2.peiid 

---Sub query to get the top Sampled (Many to one relationships)
		AND petaxhistoryiid IN (SELECT TOP 1 petaxhistoryiid FROM petaxhistory AS pt2 WHERE 
		(spetaxhistory.petaxhistoryiid) IS NOT NULL
		AND spetaxhistory.classtype IN (2,4) AND #ncss_one2.peiid IN ( pt2.peiidref)
...
FROM site AS s1 
INNER JOIN area AS county ON county.areaiid=s1.countyareaiidref 
INNER JOIN areatype AS co ON co.areatypeiid=county.areatypeiidref AND co.areatypename = 'County or Parish' AND s1.siteiid=a.siteiid ) AS county_symbol, 

(SELECT TOP 1  areasymbol AS state_code
FROM site AS s1 
INNER JOIN area AS st ON st.areaiid=s1.stateareaiidref
INNER JOIN areatype AS co ON co.areatypeiid=st.areatypeiidref AND co.areatypename = 'State or Territory' AND s1.siteiid=a.siteiid ) AS state_symbol, 

(SELECT TOP 1  areasymbol AS mlra_code
FROM site AS s1 
INNER JOIN area AS m ON m.areaiid=s1.mlraareaiidref
INNER JOIN areatype AS co ON co.areatypeiid=m.areatypeiidref AND co.areatypename = 'mlra' AND s1.siteiid=a.siteiid ) AS mlra_symbol,

(SELECT TOP 1  areasymbol AS ssa_symbol
FROM  site AS s1
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'Non-MLRA Soil Survey Area' ) AS ssa_symbol,

(SELECT TOP 1  areasymbol AS park_symbol
FROM  site AS s1
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'National Park System Land' ) AS park_symbol,

(SELECT TOP 1  areasymbol AS forest_symbol
FROM  site AS s1
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'forest_symbol' ) AS forest_symbol,
...
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'County or Parish' ) AS county_symbol2,
...
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'State or Territory' ) AS state_symbol2,
...
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'mlra' ) AS mlra_symbol2,

(SELECT TOP 1 CASE WHEN textsubcat =  'Undisclosed Location'  THEN 'Yes' ELSE 'No' END
FROM  site AS s1
INNER JOIN sitetext ON sitetext.siteiidref=s1.siteiid AND sitetext.textsubcat =  'Undisclosed Location' AND s1.siteiid=a.siteiid ) AS undisclosed_Location_flag,
(SELECT TOP 1  areasymbol AS country_symbol
FROM  site AS s1
INNER JOIN  siteaoverlap ON siteaoverlap.siteiidref=s1.siteiid AND s1.siteiid=a.siteiid 
INNER JOIN  area AS SSAs ON SSAs.areaiid=siteaoverlap.areaiidref
INNER JOIN  areatype AS SSA ON SSA.areatypeiid=SSAs.areatypeiidref AND SSA.areatypename = 'Country' ) AS country_symbol
FROM #ncss_one2 AS a
--------
...
CASE WHEN undisclosed_Location_flag = 'Yes' THEN NULL ELSE  latstddecimaldegrees END  AS    [latitude_decimal_degrees],
CASE WHEN undisclosed_Location_flag = 'Yes' THEN NULL ELSE  longstddecimaldegrees END	AS   [longitude_decimal_degrees],
 ...
 -- The keys need to all be filled out somehow up to from country to SSA
	...
	CASE WHEN state_symbol IS NULL THEN state_symbol2  ELSE state_symbol END AS  state_symbol  ,	     --[state_key] -- Need to be converted to SSL Repo Area Key
	CASE WHEN  county_symbol  IS NULL THEN county_symbol2 ELSE county_symbol  END AS county_symbol ,	     --[county_key] -- Need to be converted to SSL Repo Area Key
	CASE WHEN  mlra_symbol IS NULL THEN mlra_symbol2 ELSE mlra_symbol END AS mlra_symbol,	     --[mlra_key] -- Need to be converted to SSL Repo Area Key
    ...
    CASE WHEN   [siteobjupdate]> [pedobjupdate] THEN CONCAT ('NASIS updated ', [siteobjupdate]) ELSE CONCAT ('NASIS updated ', [pedobjupdate])  END AS   [note] ,
      [samp_taxfamhahatmatcl],
      [corr_taxfamhahatmatcl],
...
FROM #ncss_one2 AS a
LEFT OUTER JOIN #correlated AS b ON b.corr_peiid_ref=a.peiid
LEFT OUTER JOIN #sampled AS c ON c.samp_peiid_ref=a.peiid
LEFT OUTER JOIN #overlap3 AS d ON d.siteiid=a.siteiid;
